...
function loadTheme(theme) {
	...
	if (theme === 'light') {
		...
		//Icon Switches
		document.getElementById('express-icon').src = 'img/icons/icon-express.svg';
		document.getElementById('node-icon').src =
			'img/icons/icon-node-js-dark.svg';
		document.getElementById('wordpress-icon').src =
			'img/icons/icon-wordpress.svg';
	} else {
		themeBtn.innerHTML = `<em></em><i class="ph-bold ph-sun"></i>`;
		document.getElementById('express-icon').src =
			'img/icons/icon-express-white.svg';
		document.getElementById('node-icon').src = 'img/icons/icon-node-js.svg';
		document.getElementById('wordpress-icon').src =
			'img/icons/icon-wordpress-white.svg';
	}
